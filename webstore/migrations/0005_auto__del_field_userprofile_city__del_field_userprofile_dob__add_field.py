...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'webstore_userprofile', 'city')

        # Deleting field 'UserProfile.dob'
        db.delete_column(u'webstore_userprofile', 'dob')

        # Adding field 'UserProfile.location'
        db.add_column(u'webstore_userprofile', 'location',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.hometown'
        db.add_column(u'webstore_userprofile', 'hometown',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.birthday'
        db.add_column(u'webstore_userprofile', 'birthday',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.photo_url'
        db.add_column(u'webstore_userprofile', 'photo_url',
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'webstore_userprofile', 'city',
                      self.gf('django.db.models.fields.CharField')(max_length=250, null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserProfile.dob'
        db.add_column(u'webstore_userprofile', 'dob',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'UserProfile.location'
        db.delete_column(u'webstore_userprofile', 'location')

        # Deleting field 'UserProfile.hometown'
        db.delete_column(u'webstore_userprofile', 'hometown')

        # Deleting field 'UserProfile.birthday'
        db.delete_column(u'webstore_userprofile', 'birthday')

        # Deleting field 'UserProfile.photo_url'
        db.delete_column(u'webstore_userprofile', 'photo_url')
    ...
    models = {
        ...
        u'webstore.discount': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 15, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'promotion_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['webstore.Promotion']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'webstore.product': {
