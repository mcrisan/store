...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Discount.description'
        db.add_column(u'webstore_discount', 'description',
                      self.gf('django.db.models.fields.TextField')(default=''),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Discount.description'
        db.delete_column(u'webstore_discount', 'description')
