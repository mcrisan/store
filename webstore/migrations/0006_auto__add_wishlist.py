...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'webstore_wishlist', (
            ...
            ('date_created', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 7, 18, 0, 0))),
        ))
    ...
    models = {
        ...
        u'webstore.discount': {
            ...
            'end_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 18, 0, 0)', 'null': 'True', 'blank': 'True'}),
            u'promotion_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['webstore.Promotion']", 'unique': 'True', 'primary_key': 'True'})
        },
        u'webstore.product': {
        ...
        u'webstore.promotion': {
            ...
            'start_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 18, 0, 0)'}),
        ...
        u'webstore.wishlist': {
            ...
            'date_created': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 7, 18, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'product': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['webstore.Product']"}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"})
        }
